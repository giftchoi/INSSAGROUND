							...
							<div class="single-post row">
								...
								<div class="col-lg-3  col-md-3 meta-details">
									...
									<div class="user-details row">
										<p class="user-name col-lg-12 col-md-12 col-6"><a href="groundScheduleList.do?groundNo=${gvo.groundNo}">내 모임 달력</a> <span class="lnr lnr-user"></span></p>
										...
										<p class="view col-lg-12 col-md-12 col-6"><a href="groundMasterPage.do">모임 관리</a> <span class="lnr lnr-eye"></span></p>
										</c:if>
